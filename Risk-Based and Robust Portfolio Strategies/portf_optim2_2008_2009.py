...
def strat_lever_equal_risk_contr(x_init, cash_init, mu, Q, cur_prices):
    ...
    x_optimal=np.floor(num_shares)
    cash_optimal=cash_init
    return validate_leverage(x_init,x_optimal,cur_prices,cash_optimal, r_rf2008_2009)
...
#Plot charts for strategy 3,4,7 to show dynamic changes in portfolio allocations.
